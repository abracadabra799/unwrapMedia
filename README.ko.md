...
**Raw 픽셀 뷰어** -- 헤더 없는 원시 픽셀 덤프. YUV420(NV12/NV21/I420/YV12), RGB565/BGR565, RGB888/BGR888, RGBA8888/ARGB8888. 멀티 프레임은 영상처럼 재생.

**바이너리 탐색기** -- 구조 트리 + 우측 패널(선택 전엔 한눈에 보는 Overview, 트리 노드 선택 시 상세 속성으로 전환, 필드 클릭 시 헥스 뷰가 해당 바이트로 이동) + 드래그 선택 가능한 헥스/raw 바이트 뷰어. 모든 패널 크기 조절 가능, 다크/라이트 테마 전환(설정 유지).
